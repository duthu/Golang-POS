        ...
        var salesChart = new Chart(salesChartCanvas, {
          ...
          options: {
            ...
            legendCallback : function(chart) {
              var text = [];
              text.push('<div>');
              text.push('<div className="d-flex align-items-center">');
              text.push('<span className="bullet-rounded" style="border-color: ' + chart.data.datasets[1].borderColor[0] +' "></span>');
              text.push('<p className="tx-12 text-muted mb-0 ml-2">Gross volume</p>');
              text.push('</div>');
              text.push('<div className="d-flex align-items-center">');
              text.push('<span className="bullet-rounded" style="border-color: ' + chart.data.datasets[0].borderColor[0] +' "></span>');
              text.push('<p className="tx-12 text-muted mb-0 ml-2">New Cusromers</p>');
              text.push('</div>');
              text.push('</div>');
              return text.join('');
            },
